...
-- NOTE The following fields are only required if the DOCUMENT.Slasher is set to nil and there is no Slasher with the given name, like Hat Man for example.
DOCUMENT.Class = SlashCo.SlasherClass.Umbra
